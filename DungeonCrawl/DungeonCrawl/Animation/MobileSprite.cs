...
namespace Animation
{
    public class MobileSprite
    {
        ...
        {
            get { return asSprite.DrawPosition; }
            set { asSprite.DrawPosition = value; }
        }
        ...
        public int HorizontalCollisionOffset
        {
            get { return iColOffsetX; }
            set { iColOffsetX = value; }
        }

        public int VerticalCollisionOffset
        {
            get { return iColOffsetY; }
            set { iColOffsetY = value; }
        }
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (bVisible)
            {
                asSprite.Draw(spriteBatch, iColOffsetX, iColOffsetY);
            }
        }
    }
}
